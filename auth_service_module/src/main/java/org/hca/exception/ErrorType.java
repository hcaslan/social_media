...
public enum ErrorType {
    ...
    ID_NOT_EXIST(5016,
            "Böyle bir ID yok.",
            HttpStatus.BAD_REQUEST),
    USERPROFILE_SERVICE_NOT_RESPONDING(6000,
            "The UserProfile service is not responding.",
            HttpStatus.INTERNAL_SERVER_ERROR), EMAIL_NOT_FOUND(6001, "Email yok",HttpStatus.BAD_REQUEST );
